...
- It does not guarantee that websites cannot correlate accounts. Network reputation, login behavior, payment details, reused content, and site-side risk systems are outside the browser container.
